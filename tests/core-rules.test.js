...
// ЕДИНЫЙ КОНТРАКТ СЮИТ (v187): машинно-читаемый итог отдельной строкой плюс
// код возврата. До этого core-rules была единственной сюитой без строки ИТОГ,
// и раннеру приходилось считать символы ✅/❌ в произвольном тексте — из-за
// чего проходящий тест с ❌ в НАЗВАНИИ давал несуществующий провал.
// Сама логика проверок не менялась: добавлены только вывод итога и exit code.
