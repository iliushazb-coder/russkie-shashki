...
// только первые 110ms; target остаётся невидимым до 120ms, поэтому
// читаемого overlap нет. Весь переход заканчивается за 180ms. Он не
...
const SCREEN_TRANSITION_FALLBACK_MS = 260; // CSS leave = 110ms + запас
...
// Старый экран виден только первые 110ms перехода. Поэтому начало
